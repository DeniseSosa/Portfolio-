  ...
  return (
    <div className="bg-neutral-900 lg:min-h-screen w-full mx-auto scroll-smooth">
      {showIntro && (
        <div className="flex flex-col justify-center items-center md:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4 lg:gap-6 w-11/12 mx-auto">
          ...
          <div className="hidden lg:grid col-span-1 row-span-3 self-center m-3">
            <h2 className="text-center text-white text-3xl lg:text-4xl p-4">
              Coder
            </h2>
            <h3 className="text-center text-white text-2xl lg:text-3xl p-2">
              Fullstack Developer
            </h3>
      ...
      <div className={`${isBannerCoder ? "banner-coder" : "hidden"}`}>
        <h2 className="text-center text-white text-3xl lg:text-6xl p-8">
          “The coder side”{" "}
        </h2>
        <div className="flex">
          <button
            onClick={onClickBack}
            className="hidden lg:block w-30 h-30 bg-fuchsia-900 m-4 p-4 rounded-md transition duration-300 hover:scale-110 hover:drop-shadow-[0_10px_15px_rgb(192,38,211)]"
          >
            <IoMdArrowRoundBack />
          </button>
          <h3 className="text-white text-base sm:text-xl lg:text-3xl leading-snug lg:w-2/6 mx-auto text-center justify-self-center self-center">
